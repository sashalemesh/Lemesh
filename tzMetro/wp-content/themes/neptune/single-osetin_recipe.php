...
get_header(); ?>
  ...
  <div class="recipe-floating-box">
    <div class="cooking-mode-btn-w">
      <a href="#" class="cooking-mode-toggler cooking-mode-btn"><i class="os-icon os-icon-paper"></i> <span><?php esc_html_e('Start Reading Mode', 'osetin'); ?></span></a>
    </div>
                      ...
                      <?php }else{ ?>
                        ...
                        <td>
                          ...
                          <?php if($searchable_ingredients){ ?>
                            ...
                            if($ingredient_obj){ ?>
                              <span class="ingredient-name"><a href="<?php echo get_term_link($ingredient_obj); ?>" target="_blank"><?php echo $ingredient_obj->name; ?></a></span>
                            <?php } ?>
                          <?php }else{ ?>
