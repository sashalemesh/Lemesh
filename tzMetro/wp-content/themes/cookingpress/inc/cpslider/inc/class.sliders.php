...
class CPSliders_Sliders_Table extends WP_List_Table {
 ...
 function __construct(){
    ...
    return parent::__construct( array(
            'singular'  => __( 'slider', 'cookingpress' ),     //singular name of the listed records
            'plural'    => __( 'sliders', 'cookingpress' ),   //plural name of the listed records
...
function get_columns(){
  $columns = array(
                ...
                'name'      =>  __('Name', 'cookingpress'),
                'slug'      =>  __('Slug', 'cookingpress'),
                'type'      =>  __('Type', 'cookingpress'),
                'slides_count'      =>  __('Slides', 'cookingpress')
                );
  return $columns;
}
...
public function get_sortable_columns() {
    ...
    */
        ...
        <span class="edit"><a href="admin.php?page=cp-slider&amp;slider=<?php echo esc_attr( $item->slug ); ?>"><?php _e( 'Edit', 'cookingpress' ); ?></a></span> |
  ...
  public function column_type( $item ) {
    ...
    */
        ...
        echo __( 'Click &lsquo;Add New&rsquo; to create a new slider.', 'cookingpress' );
