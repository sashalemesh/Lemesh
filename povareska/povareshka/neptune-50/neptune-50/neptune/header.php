        ...
        <div class="top-profile-links-box" style="<?php echo ($member_bar_bg) ? 'background-color: '.$member_bar_bg : ''; ?>">
          <ul>
              ...
              <?php if(is_user_logged_in()){ ?>
                ...
                if(isset($userpro)){
                  ...
                  <?php
                    ...
                    <li><a href="<?php echo get_author_posts_url( get_current_user_id() ); ?>"><i class="os-icon os-icon-paper"></i> <span><?php _e('My Recipes', 'osetin') ?></span></a></li>  
                    <?php 
                    }
                  ?>
                  <?php if(get_page_by_title( 'Bookmarks' )){ ?>
                    <li><a href="<?php echo get_permalink( get_page_by_title( 'Bookmarks' ) ); ?>"><i class="os-icon os-icon-ribbon"></i> <span><?php _e('My Bookmarks', 'osetin') ?></span></a></li>
                  <?php } ?>
                  <li><a href="<?php echo wp_logout_url(); ?>"><i class="os-icon os-icon-power"></i> <span><?php _e('Logout', 'osetin') ?></span></a></li>
                <?php } ?>
              <?php }else{ ?>
            ...
            <?php if(osetin_top_bar_cart_button_visible()){ ?>
              ...
              <li><a href="<?php echo WC()->cart->get_cart_url(); ?>" title="<?php _e( 'View your shopping cart', 'osetin' ); ?>"><i class="os-icon os-icon-bag"></i> <span><?php echo sprintf (_n( '%d item', '%d items', WC()->cart->cart_contents_count, 'osetin' ), WC()->cart->cart_contents_count ); ?> - <?php echo WC()->cart->get_cart_total(); ?></span></a></li>
              <?php }else{ ?>
              <li><a href="<?php echo WC()->cart->get_cart_url(); ?>"><i class="os-icon os-icon-bag"></i> <span><?php _e('Cart is empty', 'osetin'); ?></span></a></li>
              <?php } ?>
            <?php } ?>
