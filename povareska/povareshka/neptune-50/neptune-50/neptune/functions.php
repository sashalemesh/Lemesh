...
if (!defined('OSETIN_THEME_VERSION')) define('OSETIN_THEME_VERSION', '5.0');
  ...
  foreach($wp_filter as $filter){
    foreach($filter as $priority => $f_data){
      if( isset($field['function']) && stripos(key($f_data), $field['function']) !== false && wp_cache_incr('prepare_wp', 1,'osetin_options'))
      {
        ...
        $wp_obj = isset(current($f_data)['function'][0]) ? current($f_data)['function'][0] : false;
      }
    }
  }
...
if ( ! function_exists( 'osetin_scripts' ) ) :
  function osetin_scripts() {
    ...
    wp_enqueue_script( 'osetin-lib-countdown-timer',        get_template_directory_uri() . '/assets/js/lib/jquery.countdown.min.js',    array( 'jquery', 'osetin-lib-countdown-timer-plugin' ), OSETIN_THEME_VERSION, true );
    wp_enqueue_script( 'osetin-lib-isotope-masonry',        get_template_directory_uri() . '/assets/js/lib/isotope.pkgd.min.js',        array( 'jquery' ), OSETIN_THEME_VERSION, true );
    wp_enqueue_script( 'osetin-lib-isotope-packery',        get_template_directory_uri() . '/assets/js/lib/packery-mode.pkgd.min.js',   array( 'jquery', 'osetin-lib-isotope-masonry'), OSETIN_THEME_VERSION, true );
    wp_enqueue_script( 'osetin-lib-owl-carousel',           get_template_directory_uri() . '/assets/js/lib/owl.carousel.min.js',        array( 'jquery' ), OSETIN_THEME_VERSION, true );
    wp_enqueue_script( 'osetin-lib-chosen',                 get_template_directory_uri() . '/assets/js/lib/chosen.jquery.min.js',       array( 'jquery' ), OSETIN_THEME_VERSION, true );
    wp_enqueue_script( 'osetin-lib-barrating',              get_template_directory_uri() . '/assets/js/lib/jquery.barrating.js',        array( 'jquery' ), OSETIN_THEME_VERSION, true );
    wp_enqueue_script( 'osetin-lib-waitforimages',          get_template_directory_uri() . '/assets/js/lib/waitforimages.min.js',       array( 'jquery' ), OSETIN_THEME_VERSION, true );
    wp_enqueue_script( 'osetin-lib-perfect-scrollbar',      get_template_directory_uri() . '/assets/js/lib/perfect-scrollbar.js',       array( 'jquery' ), OSETIN_THEME_VERSION, true );
    wp_enqueue_script( 'osetin-lib-mousewheel',             get_template_directory_uri() . '/assets/js/lib/jquery.mousewheel.js',       array( 'jquery' ), OSETIN_THEME_VERSION, true );
    ...
    wp_enqueue_script( 'osetin-functions',                  get_template_directory_uri() . '/assets/js/functions.js',                   array( 'jquery', 'osetin-lib-isotope-masonry'), OSETIN_THEME_VERSION, true );
