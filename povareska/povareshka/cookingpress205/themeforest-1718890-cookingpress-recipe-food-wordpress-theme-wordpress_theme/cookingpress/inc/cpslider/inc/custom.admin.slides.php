...
<form  name="new-slider-form" id="new-slider-form" method="post" action="admin.php?page=cp-slider&slider=<?php echo $_GET['slider']; ?>&action=save_slides">
    <p><?php _e('This slider will displayed featured images from selected posts:','cookingpress') ?></p>
    ...
    <div id="cpslides-cont">
        <ul>
            <?php if($current_slider){
                ...
                <li data-counter='<?php echo $slidescounter; ?>' class="toClone">
                   ...
                   <div class="cpSlideOptions">
                    <p>
                        <input class="upload_image" type="text" size="36" data-name="slider_image" name="slide[<?php echo $slidescounter; ?>][slider_image]" value="<?php echo $slide['slider_image']; ?>" />
                    </p>
                    <p><input type="text" data-name="video" name="slide[<?php echo $slidescounter; ?>][video]" class="video_url" placeholder="Video URL" value="<?php echo $slide['video']; ?>"></p>
                    <p><textarea data-name="html_content" name="slide[<?php echo $slidescounter; ?>][html_content]" class="html_content" cols="30" rows="10"><?php echo $slide['html_content']; ?></textarea></p>
                    <p>
                        <select data-name="captionstyle" name="slide[<?php echo $slidescounter; ?>][captionstyle]" class="captionstyle">
        ...
        <li data-counter='0' class="toClone">
            <div class="cpSlideThumb" style="background-image: url('http://themes.loc/cookingpress/wp-content/plugins/new-royalslider/lib/backend/img/empty150.png');">
                <a href="#">edit</a>
                <a href="#">remove</a>
            </div>
            <div class="cpSlideOptions">
