            ...
            <td>
                ...
                $orderby = array(
                    ...
                    <select name="posts_order" id="posts_order">
                        ...
                        <option <?php selected( $current_slider['posts_order'], $key ); ?> value="<?php echo $key; ?>"><?php echo $value; ?></option>
                        <?php } ?>
                    </select>
                </td>
            </tr>
                    ...
                    <select id="cpsliderselect" multiple="multiple" name="cats[]" title="Click to select categories for slider">
                        ...
                        if ($categories) {
                            foreach($categories as $category) {
                                if ($category->count > 0) { ?>
                                <option <?php if (is_array($selectedcats) && in_array( $category->term_id, $selectedcats)) { echo "selected "; } ?> value="<?php echo $category->term_id; ?>"><?php echo $category->name; ?></option>
                                <?php }
                            }
                        }
                        ?>
                    ...
                    <select id="cpsliderselecttags" multiple="multiple" name="tags[]" title="Click to select categories for slider">
                        ...
                        if ($categories) {
                            foreach($categories as $tag) {
                                if ($tag->count > 1) { ?>
                                <option <?php if (is_array($selectedtags) && in_array( $tag->term_id, $selectedtags)) { echo "selected "; } ?> value="<?php echo $tag->term_id; ?>"><?php echo $tag->name; ?></option>
                                <?php }
                            }
                        }
                        ?>
