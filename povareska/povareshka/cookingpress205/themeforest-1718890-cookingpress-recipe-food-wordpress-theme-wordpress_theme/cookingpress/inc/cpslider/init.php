...
class CP_Slider
{
    ...
    public function register_plugin_scripts() {
      ...
      if(is_home() || is_page_template('template-sliderpage.php') || is_page_template('template-excerpt.php') || is_page_template('template-grid.php') || is_page_template('template-full.php') ) {
    ...
    public function add_menus() {
        ...
        add_menu_page(
            ...
            __( 'CookingPress Slider', 'purepress' ),                                 /* title of options menu item */
